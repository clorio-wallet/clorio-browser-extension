    ...
    return (
      <div className="relative">
        <Input
          ...
          className={cn(
            "relative z-10 border-none bg-transparent shadow-none px-0 h-auto text-5xl font-semibold tracking-tight focus-visible:ring-0 focus-visible:ring-offset-0 text-transparent caret-current",
            className
          )}
        />
